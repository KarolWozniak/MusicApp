...
public class Parser {
    ...
    private static final String link = "http://159.89.111.2:8080/api/converter?url=https://www.youtube.com/watch?v=";
    ...
    public String getImage(int number){
        return "https://img.youtube.com/vi/" + videoId + "/" + number + ".jpg";
    }
